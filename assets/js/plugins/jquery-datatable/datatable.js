            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    ...
                    "oLanguage": {                              // language settings
                        "sProcessing":              '<img src="'+ base_url +'/assets/img/loading-spinner-blue.gif"/><span>&nbsp;&nbsp;Loading...</span>',
                    ...
                    "fnServerParams": function ( aoData ) {
                        ...
                        for(var i in ajaxParams) {
                            ...
                            aoData.push({"name" : param.name, "value": param.value, 'csrf_erp' : $('input[name="csrf_erp"]').val()});
                        }
                    },
