...
$.extend( $.fn.dataTableExt.oPagination, {
	"bootstrap": {
		"fnInit": function( oSettings, nPaging, fnDraw ) {
			...
			$(nPaging).append(
				'<ul class="pagination">'+
					'<li class="prev disabled"><a href="#" title="'+oLang.sPrevious+'"><i class="material-icons">chevron_left</i></a></li>'+
					'<li class="next disabled"><a href="#" title="'+oLang.sNext+'"><i class="material-icons">chevron_right</i></a></li>'+
				'</ul>'
			);
...
$.extend( $.fn.dataTableExt.oPagination, {
    "bootstrap_full_number": {
        "fnInit": function( oSettings, nPaging, fnDraw ) {
            ...
            $(nPaging).append(
                '<ul class="pagination">' +
                    '<li class="prev disabled"><a href="#" title="' + oLang.sFirst + '"><i class="material-icons">first_page</i></a></li>' +
                    '<li class="prev disabled"><a href="#" title="' + oLang.sPrevious + '"><i class="material-icons">chevron_left</i></a></li>'+
                    '<li class="next disabled"><a href="#" title="' + oLang.sNext + '"><i class="material-icons">chevron_right</i></a></li>' +
                    '<li class="next disabled"><a href="#" title="' + oLang.sLast + '"><i class="material-icons">last_page</i></a></li>' +
                '</ul>'
            );
            var els = $('a', nPaging);
    ...
    "bootstrap_extended": {
        "fnInit": function( oSettings, nPaging, fnDraw ) {
            ...
            $(nPaging).append(
                ...
                '<a href="#" class="btn btn-sm default prev disabled" title="' + oLang.sPrevious + '"><i class="material-icons">chevron_left</i></a>' +
                ...
                '<a href="#" class="btn btn-sm default next disabled" title="' + oLang.sNext + '"><i class="material-icons">chevron_right</i></a> ' +
