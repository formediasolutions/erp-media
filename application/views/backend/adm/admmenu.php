        ...
        <div class="m-portlet m-portlet--mobile">
			...
			<div class="m-portlet__body">
				<div class="table-container table-responsive">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="menu_list" data-url="<?php echo base_url('menulistdata'); ?>">
                        <thead>
    						<tr role="row" class="heading bg-blue">
                                ...
                                <th class="width15 text-center">Page Name</th>
                                <th class="width10 text-center">Menu Level</th>
                            ...
                            <tr role="row" class="filter display-hide table-filter">
                                ...
                                <td>
                                    <select name="search_type" class="form-control m-input form-control-sm form-filter">
                                ...
                                <td></td>
                                <td>
                                    <select name="search_status" class="form-control m-input form-control-sm form-filter">
    									<option value="">Pilih...</option>
    									<?php
                                            /*
                                ...
                                <td>
    								<div class="input-group input-group-sm date date-picker bottom5" data-date-format="yyyy-mm-dd">
										<input type="text" class="form-control sm-input form-filter" readonly name="search_datecreated_min" placeholder="From" />
										<span class="input-group-btn">
											<button class="btn btn-sm btn-info btn-flat" type="button"><i class="fa fa-calendar"></i></button>
										</span>
									</div>
									<div class="input-group input-group-sm date date-picker" data-date-format="yyyy-mm-dd">
										<input type="text" class="form-control sm-input form-filter" readonly name="search_datecreated_max" placeholder="To" />
										<span class="input-group-btn">
											<button class="btn btn-sm btn-info btn-flat" type="button"><i class="fa fa-calendar"></i></button>
										</span>
									</div>
    							...
    							<td style="text-align: center;">
    								<button class="btn m-btn--pill m-btn--air btn-primary btn-sm filter-submit" id="btn_list_menu">Search</button>
